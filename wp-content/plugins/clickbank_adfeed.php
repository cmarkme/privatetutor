...
function widget_clickbankfeed( $args, $widget_args = 1 ) {
        ...
        $url =  $url_base. $affiliate_id . '/' . $tracking_code . '/?' .
                   "n=$n&categories=$categories&keywords=$keywords";
        // Fetch it
...
<div>
                <p>
                        <label for="widget-clickbankfeed-title<?php echo $number; ?>">Title:
                        <input class="widefat" id="widget-clickbankfeed-title-<?php echo $number; ?>" name="widget-clickbankfeed[<?php echo $number; ?>][title]" type="text" value="<?php echo $current_options['title']; ?>"/>
                        </label>
                ...
                <p><label for="widget-clickbankfeed-affiliate_id-<?=$number;?>">Clickbank ID: <input type="text" class="widefat" id="widget-clickbankfeed-affiliate_id-<?=$number;?>" name="widget-clickbankfeed[<?=$number;?>][affiliate_id]" value="<?php echo( htmlspecialchars( $current_options['affiliate_id'], ENT_QUOTES) );?>" /></label></p>
